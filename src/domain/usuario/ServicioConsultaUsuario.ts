...
//   paso 25 → obtenerAdminPorDefecto()    (resolución: id del admin)
// =============================================================================
...
export class ServicioConsultaUsuario {
  ...
  /**
   * obtenerAdminPorDefecto — C-01, paso 25.
   *
   * Devuelve el id del primer administrador registrado en el sistema.
   ...
   */
  async obtenerAdminPorDefecto(): Promise<number> {
